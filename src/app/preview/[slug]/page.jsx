                                ...
                                <div className={styles.infoContainer}>
                                    <div className={styles.item}>
                                        ...
                                        <div className={styles.postDetails}>
                                            ...
                                            <p className={styles.tag}>{ blogData.category === 'Select A Category' ? '' : blogData.category }</p>
                                        </div>
                                    </div>
                                    <div className={styles.item} style={{ '--img': `url(${blogData.image})` }}>
                                        <Image fill src={blogData.image} alt={blogData.title} className={styles.img}/>
                                    </div>
                                </div>
