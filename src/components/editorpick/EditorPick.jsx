    ...
    <div className={styles.container}>
      ...
      <div className={styles.editorsPickContainer}>
        ...
        <div className={styles.rowTwo}>
            <div className={styles.item}>
                <div className={styles.innerContainer}>
                    <Image src={'/fashion.png'} fill alt='img' className={styles.img}/>
                </div>
                <div className={styles.innerContainer}>
            ...
            <div className={styles.item}>
                <div className={styles.innerContainer}>
                    <Image src={'/food.png'} fill alt='img' className={styles.img}/>
                </div>
                <div className={styles.innerContainer}>
                    <div className={styles.postTagTime}>
                        <p className={styles.tag}>Travel</p>
        ...
        <div className={styles.rowTwo}>
            <div className={styles.item}>
                <div className={styles.innerContainer}>
                    <Image src={'/coding.png'} fill alt='img' className={styles.img}/>
                </div>
                <div className={styles.innerContainer}>
                    <div className={styles.postTagTime}>
                        <p className={styles.tag}>Travel</p>
            ...
            <div className={styles.item}>
                <div className={styles.innerContainer}>
                    <Image src={'/culture.png'} fill alt='img' className={styles.img}/>
                </div>
                <div className={styles.innerContainer}>
                    <div className={styles.postTagTime}>
                        <p className={styles.tag}>Travel</p>
            ...
            <div className={styles.item}>
                <div className={styles.innerContainer}>
                    <Image src={'/travel.png'} fill alt='img' className={styles.img}/>
                </div>
                <div className={styles.innerContainer}>
                    <div className={styles.postTagTime}>
                        <p className={styles.tag}>Travel</p>
